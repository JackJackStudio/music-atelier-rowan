...
const tracks = [
  ["07", "The Knight of Aurelia", "Jessara is now queen, but the war continues. Cedric, her childhood companion, has become one of Aurelia's leading knights and returns again and again to the front. She has already lost her father and cannot bear the thought of losing him too."],
  ...
  ["09", "When the Knight Fell", "Cedric is carried back to the castle gravely wounded. The sight brings Jessara back to the day her father returned from war. The silver-winged fairy uses gentle magic to help stabilize him, but new reports warn that Aurelia's defenses are collapsing."],
  ...
  ["11", "The Last Battle of Aurelia", "The fairy returns with the intelligence Aurelia desperately needs. Jessara chooses a final counterattack, and the recovering Cedric rejoins the army. The battle is brutal, but Aurelia exploits the enemy's weakness and finally turns the war."],
  ["12", "Peace Returns to the Valley", "The war ends. The surviving soldiers return home, Cedric lives, and the fairy is again beside Jessara. Morning sunlight returns to the valley — echoing the first track — but the child who once ran through the garden is now a true queen."],
];
